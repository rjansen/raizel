...
import (
	...
	"github.com/rjansen/raizel/firestore/internal/testutil"
...
var cmpOpts = []cmp.Option{
	cmp.AllowUnexported(firestore.DocumentRef{}, firestore.CollectionRef{}, firestore.DocumentSnapshot{},
		firestore.Query{}),
	cmpopts.IgnoreTypes(firestore.Client{}, &firestore.Client{}),
}
...
func newMock(t *testing.T) (*firestore.Client, *mockServer) {
...
func tsval(t time.Time) *pb.Value {
	...
	return &pb.Value{ValueType: &pb.Value_TimestampValue{TimestampValue: ts}}
}
